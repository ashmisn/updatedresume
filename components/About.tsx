          ...
          <div className="bg-card/70 backdrop-blur-sm rounded-3xl shadow-xl p-8 md:p-12 border-2 border-pink-100">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground italic mb-2">B.Tech in Computer Science | Aug 2023 - Present</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p className="font-handwritten text-xl text-muted-foreground italic mt-6">
